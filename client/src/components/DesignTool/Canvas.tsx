...
const Canvas: React.FC = () => {
  ...
  // Initialize comprehensive drag-and-drop system
  const dragAndDropV2 = useDragAndDropV2();
          ...
          {(rootElement.children || []).map((childId: string) => {
            ...
            return (
              <CanvasElement 
                ...
                onElementDragStart={dragAndDropV2.handleElementDragStart}
                onElementDragOver={dragAndDropV2.handleDragOver}
                onElementDragLeave={dragAndDropV2.handleDragLeave}
                onElementDrop={dragAndDropV2.handleDrop}
                onElementDragEnd={dragAndDropV2.handleDragEnd}
                getDropClasses={dragAndDropV2.getDropClasses}
              />
            );
          })}
        </div>
